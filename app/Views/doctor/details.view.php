<div class="row">
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <i class="fa fa-graduation-cap"></i> Doctors
            </li>
            <li class="active">
                <i class="fa fa-graduation-cap"></i> <?=$doctor->name?>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 text-right">
                <div class="btn-group text-center">
                    ...
                    <a href="http://www.students.com/doctor/edit/<?=$doctor->id?>"
                       class="btn btn-success btn-sm btn-default"><i class="fa fa-edit fa-1x"></i></a>

                    <a href="http://www.students.com/doctor/delete/<?=$doctor->id?>"
